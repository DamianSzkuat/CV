...
class LeaveOneOutModelFittingContainer(tk.Frame):
    ...
    def __init__(self, parent, frameFactory, meanModels):
        ...
        self.radioImages = self.frameFactory.createLefOutRadiographFrame(self, meanModels=self.meanModels, drawLandmarks=False)
        self.show()
